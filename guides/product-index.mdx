...
Build and maintain your own product index by combining Catalog’s browse and product endpoints. You can either **discover products via vendors and collections** or **index a self-selected set of product URLs**.
