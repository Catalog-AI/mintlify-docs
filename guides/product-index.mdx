...
<Note>
This guide covers both approaches: discovering products via [Get Vendors](/api-reference/endpoints/browse/list-vendors) and collections, or indexing a self-selected set of URLs via [Get Products](/api-reference/endpoints/products/get-products).
</Note>
...
Use the **Get Vendors** endpoint to discover which vendors are available and how many products they have.
...
<CardGroup cols={2}>
  <Card title="Get Vendors" icon="store" href="/api-reference/endpoints/browse/list-vendors">
    Discover available vendors
  </Card>
  <Card title="Get Collections" icon="folder" href="/api-reference/endpoints/browse/list-collections">
    Browse vendor collections
  </Card>
  <Card title="Get All Products" icon="list" href="/api-reference/endpoints/browse/list-listings">
