...
description: "Master advanced filtering techniques for precise product discovery"
---

The Catalog API provides powerful filtering capabilities to help you find exactly the products you need. Combine different filter types for precise results.

## Available filters

All filters work with [Search](/api-reference/endpoints/search/regular-search) and [Agentic Search](/api-reference/endpoints/search/agentic-search) endpoints.
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" href="/quickstart">
    Learn basic filtering with your first request
  </Card>
  <Card title="Pagination" icon="chevrons-right" href="/guides/pagination">
    Handle large filtered result sets
  </Card>
  <Card title="Search API" icon="magnifying-glass" href="/api-reference/endpoints/search/regular-search">
    Complete filter parameters reference
  </Card>
