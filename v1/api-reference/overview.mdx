...
|:---------|:-------|:------------|
| [`/v1/crawl`](/v1/api-reference/endpoints/discover/start-crawl) | POST | Start async discovery of collections and product listings for a specific vendor |
...
| Endpoint | Method | Description |
|:---------|:-------|:------------|
| [`/v1/products`](/v1/api-reference/endpoints/extract/retrieve-products) | POST | Start async extraction from product URLs (up to 1000) |
