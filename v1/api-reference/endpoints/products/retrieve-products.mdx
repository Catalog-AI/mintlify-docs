...
<Note>
**Async Processing:** This endpoint starts processing asynchronously and returns an `execution_id` immediately. Use the [Get Execution Status](/v1/api-reference/endpoints/products/get-execution-status) endpoint to check progress and retrieve results when processing completes.
</Note>
...
<ResponseField name="execution_id" type="string">
  Unique execution identifier for this batch processing job. Use this ID with the [Get Execution Status](/v1/api-reference/endpoints/products/get-execution-status) endpoint to check progress and retrieve results.
...
1. Use the `execution_id` to poll the [Get Execution Status](/v1/api-reference/endpoints/products/get-execution-status) endpoint
...
3. **Check Status:** Poll the [Get Execution Status](/v1/api-reference/endpoints/products/get-execution-status) endpoint using the `execution_id`
