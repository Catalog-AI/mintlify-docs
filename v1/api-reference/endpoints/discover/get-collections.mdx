...
<Tip>
**When to use:** Browse vendor collections before fetching products. Use with [Get All Products](/v1/api-reference/endpoints/discover/get-products) to get products from specific collections.
</Tip>
