...
<ResponseField name="executions" type="array">
  ...
  <Expandable title="Execution Summary">
    <ResponseField name="execution_id" type="string">
      Unique execution identifier. Use this ID with the [Get Execution Status](/v1/api-reference/endpoints/crawl/get-execution-status) endpoint to check detailed status and results.
...
const processingResponse = await fetch(
  'https://api.getcatalog.ai/v1/crawl?status=processing',
  {
    headers: {
      'x-api-key': 'YOUR_API_KEY'
    }
...
```json Success Response
{
  "executions": [
    ...
    {
      "execution_id": "crawl-another-site-b5e6f7g8",
      "status": "processing",
      "created_at": "2025-01-15T11:00:00.000Z"
    },
    {
      "execution_id": "crawl-third-site-c9d0e1f2",
      "status": "failed",
