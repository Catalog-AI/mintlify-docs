...
This is ideal for initial discovery of a new vendor. Use the [Get Products](/v1/api-reference/endpoints/extract/retrieve-products) endpoint to get full product details from discovered listings.
</Tip>
