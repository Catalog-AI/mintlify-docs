...
Retrieve the status and results for an asynchronous crawl job started via the [Start Crawl](/v1/api-reference/endpoints/discover/start-crawl) endpoint.
...
**Cancel Running Executions:** If you need to stop a crawl that is currently running, use the [Cancel Crawl Execution](/v1/api-reference/endpoints/discover/cancel-crawl-execution) endpoint to stop the execution.
</Note>
...
<ParamField path="execution_id" type="string" required>
  The execution ID returned from the [Start Crawl](/v1/api-reference/endpoints/discover/start-crawl) POST endpoint
...
5. **Cancellation:** If a crawl is taking too long or you need to stop it, use the [Cancel Crawl Execution](/v1/api-reference/endpoints/discover/cancel-crawl-execution) endpoint to stop running executions
