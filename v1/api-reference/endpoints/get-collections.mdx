...
<Tip>
**When to use:** Browse vendor collections before fetching products. Use with [`POST /v1/listings`](/v1/api-reference/endpoints/get-listings) to get products from specific collections.
</Tip>
