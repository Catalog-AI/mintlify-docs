...
<Note>
**Async Processing:** This endpoint starts processing asynchronously and returns an `execution_id` immediately. Use the [Get Execution Status](/v1/api-reference/endpoints/extract/get-products-execution-status) endpoint to check progress and retrieve results when processing completes.
</Note>

<Tip>
**Managing Executions:** 
- **View All Executions:** You can view all your product processing executions using the [List Product Executions](/v1/api-reference/endpoints/extract/list-products-executions) endpoint to see all processing jobs, their statuses, and when they were created.
- **Cancel Running Executions:** If you need to stop a running execution, use the [Cancel Product Execution](/v1/api-reference/endpoints/extract/cancel-products-execution) endpoint.
</Tip>
...
<ResponseField name="execution_id" type="string">
  Unique execution identifier for this batch processing job. Use this ID with the [Get Execution Status](/v1/api-reference/endpoints/extract/get-products-execution-status) endpoint to check progress and retrieve results.
...
1. Use the `execution_id` to poll the [Get Execution Status](/v1/api-reference/endpoints/extract/get-products-execution-status) endpoint
...
3. **Check Status:** Poll the [Get Execution Status](/v1/api-reference/endpoints/extract/get-products-execution-status) endpoint using the `execution_id`
