    ...
    <ResponseField name="products" type="array">
      ...
      <Expandable title="Product Result" defaultOpen>
        ...
        <ResponseField name="retry" type="boolean">
          Whether retrying this URL may produce a successful result. When `true`, the failure is likely transient. When `false`, the URL itself needs fixing.
        </ResponseField>
    ...
    <ResponseField name="meta" type="object">
      ...
      <Expandable title="Meta Properties">
        ...
        <ResponseField name="total_failed_by_reason" type="object">
          Breakdown of retriable failures by outcome
          
          <Expandable title="Failed Breakdown">
            <ResponseField name="automated_access_not_permitted" type="number">
              URLs where the site blocked automated access
            </ResponseField>
            
            <ResponseField name="other" type="number">
              URLs that encountered a temporary processing error
            </ResponseField>
          </Expandable>
        </ResponseField>
...
```json Status: Completed (Mixed Results)
{
  "status": "completed",
  "progress": {
