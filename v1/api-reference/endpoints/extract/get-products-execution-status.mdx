...
Retrieve the status, progress, and results for an asynchronous batch processing job started via the [Get Products by URLs](/v1/api-reference/endpoints/extract/retrieve-products) endpoint.
...
<Tip>
**Managing Executions:** 
- **View All Executions:** Use the [List Product Executions](/v1/api-reference/endpoints/extract/list-products-executions) endpoint to see all your processing jobs
...
<ParamField path="execution_id" type="string" required>
  The execution ID returned from the [Get Products by URLs](/v1/api-reference/endpoints/extract/retrieve-products) POST endpoint
