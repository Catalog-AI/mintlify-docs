---
title: "Cancel Product Execution"
api: "DELETE https://api.getcatalog.ai/v1/products/{execution_id}"
description: "Cancel a running product processing execution"
---

Cancel a running product processing execution. This endpoint stops an active product batch processing job that is currently processing.
