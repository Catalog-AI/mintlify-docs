...
<Tip>
**When to use:** Browse all products from a vendor or filter by specific collections. Use with [Get Collections](/v1/api-reference/endpoints/listings/get-collections) to discover available collections first.
</Tip>
