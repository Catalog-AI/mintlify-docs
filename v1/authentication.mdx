...
To access the Catalog API, you need an API key. Get your API key from the [Catalog Dashboard](https://dashboard.getcatalog.ai).
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="book" href="/v1/api-reference/overview">
