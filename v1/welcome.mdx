...
<CardGroup cols={2}>
  <Card title="/crawl" icon="spider" href="/v1/api-reference/endpoints/discover/start-crawl">
    Start asynchronous crawling of vendor websites to discover collections and product listings
  </Card>
    <Card title="/products" icon="box" href="/v1/api-reference/endpoints/extract/retrieve-products">
    Extract detailed product information by URL
  </Card>
...
<Steps>
  ...
  <Step title="Make your first request">
    Follow our [Quickstart guide](/v1/quickstart) to search for products in under 5 minutes.
  </Step>
  <Step title="Explore the API">
    Browse the [API Reference](/v1/api-reference/overview) to discover all capabilities.
  </Step>
</Steps>
