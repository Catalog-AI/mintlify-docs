...
Use the **Start Crawl** endpoint (`POST /v1/crawl`) to discover all product listings from a vendor website. This endpoint:
...
Use the **Get Products** endpoint (`POST /v1/products`) to add any products whose listings weren't discovered during crawl, or to refresh specific products from your own URL list.
