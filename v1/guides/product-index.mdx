...
Use the **Get Products** endpoint (`POST /v1/products`) to add any products that weren't discovered during crawl, or to refresh specific products from your own URL list.
