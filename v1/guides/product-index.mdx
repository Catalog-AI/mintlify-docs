...
<CardGroup cols={2}>
  <Card title="/crawl" icon="spider" href="/v1/api-reference/endpoints/discover/start-crawl">
  ...
  <Card title="/listings" icon="list" href="/v1/api-reference/endpoints/discover/get-products">
