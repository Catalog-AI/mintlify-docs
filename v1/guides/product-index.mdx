...
Once you have a list of product URLs, use the **Get Products** endpoint (`POST /v1/products`) to hydrate many URLs in a single request (up to 1000 URLs per request).
