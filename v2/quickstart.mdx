...
<Tabs>
  <Tab title="Python">
    ...
    <Tabs>
      ...
      <Tab title="Extract Products">
        Extract products from direct URLs. Supports 1 to 1000 URLs per request.
  ...
  <Tab title="JavaScript">
    ...
    <Tabs>
      <Tab title="Get Vendors">
        ...
        const response = await fetch('https://api.getcatalog.ai/v2/vendors', {
          headers: {
  ...
  <Tab title="cURL">
    ...
    <Tabs>
      <Tab title="Get Vendors">
        ...
        ```bash
        curl -X GET https://api.getcatalog.ai/v2/vendors \
