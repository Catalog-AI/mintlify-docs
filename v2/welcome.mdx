...
<CardGroup cols={2}>
  <Card title="/vendors" icon="store" href="/v2/api-reference/endpoints/listings/get-vendors">
    Browse available vendors and product counts
  </Card>
    <Card title="/products" icon="box" href="/v2/api-reference/endpoints/products/get-products">
