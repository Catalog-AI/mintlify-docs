...
|:---------|:-------|:------------|
| [`/v2/crawl`](/v2/api-reference/endpoints/discover/start-crawl) | POST | Start async discovery of collections and product listings for a specific vendor |
| [`/v2/crawl`](/v2/api-reference/endpoints/discover/list-crawl-executions) | GET | List all crawls with status |
| [`/v2/crawl/{execution_id}`](/v2/api-reference/endpoints/discover/get-crawl-status) | GET | Get crawl status and results |
| [`/v2/crawl/{execution_id}`](/v2/api-reference/endpoints/discover/cancel-crawl-execution) | DELETE | Cancel a running crawl |
| [`/v2/vendors`](/v2/api-reference/endpoints/discover/get-vendors) | GET | List all indexed vendors |
| [`/v2/collections`](/v2/api-reference/endpoints/discover/get-collections) | POST | Get all collections for a vendor |
| [`/v2/listings`](/v2/api-reference/endpoints/discover/get-listings) | POST | Get product listings |

### Extract

| Endpoint | Method | Description |
|:---------|:-------|:------------|
| [`/v2/extract`](/v2/api-reference/endpoints/extract/extract) | POST | Start async extraction for a specific vendor or set of product URLs |
| [`/v2/extract`](/v2/api-reference/endpoints/extract/list-extract-executions) | GET | List all extractions with status |
| [`/v2/extract/{execution_id}`](/v2/api-reference/endpoints/extract/get-extract-status) | GET | Get extraction status and results |
| [`/v2/extract/{execution_id}`](/v2/api-reference/endpoints/extract/cancel-extract-execution) | DELETE | Cancel a running extraction |

### Search

| Endpoint | Method | Description |
|:---------|:-------|:------------|
| [`/v2/agentic-search`](/v2/api-reference/endpoints/search/agentic-search) | POST | Start async natural language search with customer profile personalization |
