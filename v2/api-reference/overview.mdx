...
|:---------|:-------|:------------|
| [`/v2/crawl`](/v2/api-reference/endpoints/discover/crawl) | POST | Async discovery of collections and product listings for a vendor |
...
| Endpoint | Method | Description |
|:---------|:-------|:------------|
| [`/v2/extract`](/v2/api-reference/endpoints/extract/extract) | POST | Async extraction from URLs or a vendor domain |
