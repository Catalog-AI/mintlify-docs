...
Retrieve the status, progress, and results for an asynchronous batch processing job started via the [Get Products by URLs](/v2/api-reference/endpoints/products/retrieve-products) endpoint.
...
<ParamField path="execution_id" type="string" required>
  The execution ID returned from the [Get Products by URLs](/v2/api-reference/endpoints/products/retrieve-products) POST endpoint
