...
<ParamField body="vendor" type="string">
  ...
  **Important:** This vendor must have been crawled previously using the [Crawl](/v2/api-reference/endpoints/discover/crawl) endpoint, or you must provide a `crawl_id` to wait for an active crawl to complete. Extraction requires product listings to have been discovered via crawl.
</ParamField>
