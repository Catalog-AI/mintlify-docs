...
<ResponseField name="meta" type="object">
  ...
  <Expandable title="Meta Properties">
    ...
    <ResponseField name="urls_to_process" type="number">
      Number of URLs that will actually be processed. For direct URLs mode, this equals `url_count` since all submitted URLs are processed.
    </ResponseField>
  </Expandable>
</ResponseField>
...
console.log(`Execution started: ${execution_id}, URLs: ${meta.url_count}, URLs to process: ${meta.urls_to_process}, Credits used: ${meta.credits_used}`);
...
print(f"Execution started: {execution_id}, URLs: {data['meta']['url_count']}, Credits used: {data['meta']['credits_used']}")print(f"Execution started: {execution_id}, URLs: {data['meta']['url_count']}, URLs to process: {data['meta']['urls_to_process']}, Credits used: {data['meta']['credits_used']}")
