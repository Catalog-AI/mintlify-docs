---
title: "Get Agentic Search Execution Status"
api: "GET https://api.getcatalog.ai/v2/agentic-search/{execution_id}"
description: "Check the status of an asynchronous agentic search job"
---

Retrieve the status and results for an asynchronous agentic search job started via the [Start Agentic Search](/v2/api-reference/endpoints/search/start-agentic-search) endpoint.
...
**Cancel Running Executions:** If you need to stop a search that is currently running, use the [Cancel Agentic Search Execution](/v2/api-reference/endpoints/search/cancel-agentic-search-execution) endpoint to stop the execution.
</Note>
...
<ParamField path="execution_id" type="string" required>
  The execution ID returned from the [Start Agentic Search](/v2/api-reference/endpoints/search/start-agentic-search) POST endpoint
...
6. **Cancellation:** If a search is taking too long or you need to stop it, use the [Cancel Agentic Search Execution](/v2/api-reference/endpoints/search/cancel-agentic-search-execution) endpoint to stop running executions