...
Retrieve the status and results for an asynchronous agentic search job started via the [Start Agentic Search](/v2/api-reference/endpoints/search/agentic-search) endpoint.
...
<ParamField path="execution_id" type="string" required>
  The execution ID returned from the [Start Agentic Search](/v2/api-reference/endpoints/search/agentic-search) POST endpoint
