...
<ResponseField name="data" type="array" optional>
  Array of products matching the search query (only present when status is "completed", up to 8 products).
    ...
    <ResponseField name="product" type="object">
      ...
      <Expandable title="Product Properties">
        ...
        <ResponseField name="variants" type="array">
          Product variants with pricing and availability
  ...
  "data": [
    {
      ...
      "product": {
        ...
        "description_html": "Meet the Safari shirt with its 100% cotton construction and relaxed fit.",
