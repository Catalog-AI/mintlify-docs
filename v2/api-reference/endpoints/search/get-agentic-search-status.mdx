...
Retrieve the status and results for an asynchronous agentic search job started via the [Agentic Search](/v2/api-reference/endpoints/search/agentic-search) endpoint.
...
<ParamField path="execution_id" type="string" required>
  The execution ID returned from the [Agentic Search](/v2/api-reference/endpoints/search/agentic-search) POST endpoint
