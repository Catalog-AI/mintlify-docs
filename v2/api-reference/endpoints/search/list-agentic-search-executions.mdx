---
title: "List Agentic Search Executions"
api: "GET https://api.getcatalog.ai/v2/agentic-search"
description: "Retrieve a list of recent agentic search executions"
---

Retrieve a list of recent agentic search executions for your organization. This endpoint allows you to see all search jobs you've started, their current status, and when they were created.
...
<ResponseField name="data" type="array">
  ...
  <Expandable title="Execution Summary">
    <ResponseField name="execution_id" type="string">
      Unique execution identifier. Use this ID with the [Get Agentic Search Execution Status](/v2/api-reference/endpoints/search/get-agentic-search-execution-status) endpoint to check detailed status and results.
...
const processingResponse = await fetch(
  'https://api.getcatalog.ai/v2/agentic-search?status=processing',
  {
    headers: {
      'x-api-key': 'YOUR_API_KEY'
    }
