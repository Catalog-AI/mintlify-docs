---
title: "Cancel Agentic Search Execution"
api: "DELETE https://api.getcatalog.ai/v2/agentic-search/{execution_id}"
description: "Cancel a running agentic search execution"
---

Cancel a running agentic search execution. This endpoint stops an active search job that is currently processing.
