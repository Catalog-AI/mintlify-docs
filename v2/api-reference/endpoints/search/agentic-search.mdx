...
<ResponseField name="execution_id" type="string">
  Unique execution identifier for this search job. Use this ID with the [Get Agentic Search Execution Status](/v2/api-reference/endpoints/search/get-agentic-search-status) endpoint to check progress and retrieve results.
