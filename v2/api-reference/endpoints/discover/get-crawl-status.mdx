...
Retrieve the status and results for an asynchronous crawl job started via the [Crawl](/v2/api-reference/endpoints/discover/crawl) endpoint.
...
<ParamField path="execution_id" type="string" required>
  The execution ID returned from the [Crawl](/v2/api-reference/endpoints/discover/crawl) POST endpoint
