...
<ResponseField name="data" type="array">
  ...
  <Expandable title="Execution Summary">
    <ResponseField name="execution_id" type="string">
      Unique execution identifier. Use this ID with [`GET /v2/crawl/{execution_id}`](/v2/api-reference/endpoints/discover/get-crawl-status) to check detailed status and results.
