...
<ResponseField name="data" type="array">
  ...
  <Expandable title="Execution Summary">
    <ResponseField name="execution_id" type="string">
      Unique execution identifier. Use this ID with the [Get Crawl Execution Status](/v2/api-reference/endpoints/discover/get-crawl-status) endpoint to check detailed status and results.
