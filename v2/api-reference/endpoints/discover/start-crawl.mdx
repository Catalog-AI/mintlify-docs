...
This is ideal for initial discovery of a new vendor. Use the [Extract](/v2/api-reference/endpoints/extract/extract) endpoint to get full product details from discovered listings.
</Tip>
