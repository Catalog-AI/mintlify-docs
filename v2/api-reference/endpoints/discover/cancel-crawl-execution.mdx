---
title: "Cancel Crawl Execution"
api: "DELETE https://api.getcatalog.ai/v2/crawl/{execution_id}"
description: "Cancel a running crawl execution"
---

Cancel a running crawl execution. This endpoint stops an active crawl job that is currently processing.
...
```bash cURL
curl -X DELETE "https://api.getcatalog.ai/v2/crawl/crawl-example-com-a1b2c3d4" \
