...
Convert product URLs into affiliate tracking links using the Wildfire network.
...
<ResponseField name="data" type="array">
  ...
  <Expandable title="Affiliate Link Result">
    <ResponseField name="wildfire_link" type="string">
      Generated Wildfire affiliate tracking link (empty string if generation failed)
    </ResponseField>
...
<Warning>
  ...
  - The Wildfire device ID must be configured for your organization
</Warning>
