...
<Tip>
**When to use:** Browse vendor collections before fetching products. Use with [`GET /v2/listings`](/v2/api-reference/endpoints/get-listings) to get products from specific collections.
</Tip>
