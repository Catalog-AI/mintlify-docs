---
title: "Get Vendors"
api: "GET https://api.getcatalog.ai/v2/vendors"
description: "List indexed vendors with pagination. Includes listing counts, collection counts, and latest update timestamps."
---

<Tip>
**When to use:** Discover available vendors before browsing their collections or building a product index. See [Building a Product Index](/v2/guides/product-index).
</Tip>
...
const response = await fetch('https://api.getcatalog.ai/v2/vendors?page=1&page_size=5', {
  headers: {
