...
<Tip>
**When to use:** Browse vendor collections before fetching products. Use with [Get All Products](/v2/api-reference/endpoints/listings/get-products) to get products from specific collections.
</Tip>
