...
Build and maintain your own product index using Catalog's crawl, browse, and extract endpoints. The typical workflow is: **crawl** a vendor to discover their product listings, **browse** the discovered data to curate which products you want, then **extract** full product data for your selected listings.
