...
Once you have a list of product URLs, use the **Extract Direct URLs** endpoint (`POST /v2/extract`) to hydrate many URLs in a single request (up to 1000 URLs per request).
