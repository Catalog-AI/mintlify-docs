...
<Note>
This guide covers both approaches: discovering products via [Get Vendors](/v2/api-reference/endpoints/listings/get-vendors) and collections, or indexing a self-selected set of URLs via [Get Products](/v2/api-reference/endpoints/products/retrieve-products).
</Note>
...
3. Receive an `execution_id` and poll the [Get Execution Status](/v2/api-reference/endpoints/products/get-execution-status) endpoint
...
<CardGroup cols={2}>
  <Card title="Get Vendors" icon="store" href="/v2/api-reference/endpoints/listings/get-vendors">
    Discover available vendors
  </Card>
  <Card title="Get Collections" icon="folder" href="/v2/api-reference/endpoints/listings/get-collections">
    Browse vendor collections
  </Card>
  <Card title="Get All Products" icon="list" href="/v2/api-reference/endpoints/listings/get-products">
