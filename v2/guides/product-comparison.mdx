...
<CardGroup cols={2}>
  <Card title="Extract Direct URLs" icon="box" href="/v2/api-reference/endpoints/extract/extract-direct-urls">
    Extract detailed product information from direct URLs
  </Card>
  <Card title="Get Extract Execution Status" icon="clock" href="/v2/api-reference/endpoints/extract/get-extract-status">
    Check status and retrieve extraction results
  </Card>
