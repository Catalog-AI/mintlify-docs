...
<Tip>
**When to use:** Best for personalized shopping experiences where you have customer profile data. For simpler searches, use [Regular Search](/api-reference/endpoints/search/regular-search).
</Tip>
