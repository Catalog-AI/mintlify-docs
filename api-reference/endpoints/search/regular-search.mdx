...
api: "POST https://api.getcatalog.ai/v1/search"
description: "Search products using natural language queries with advanced filtering"
---

Search for products using intelligent semantic search with natural language understanding. Supports complex filtering, pagination, and returns structured product data.

<Tip>
**When to use:** Best for high-volume search with filtering. For AI-personalized results, use [Agentic Search](/api-reference/endpoints/search/agentic-search).
</Tip>
