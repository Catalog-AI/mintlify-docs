...
<Tip>
**When to use:** Ideal for autocomplete, quick previews, or when you need fast AI-enriched results with a small result set. For larger result sets, use [Agentic Search](/api-reference/endpoints/search/agentic-search).
</Tip>
