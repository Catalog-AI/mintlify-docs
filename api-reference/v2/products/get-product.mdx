...
api: "POST https://api.getcatalog.ai/v2/product"
...
```bash cURL
curl -X POST https://api.getcatalog.ai/v2/product \
...
const response = await fetch('https://api.getcatalog.ai/v2/product', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://api.getcatalog.ai/v2/product',
    headers={
        'Content-Type': 'application/json',
        'x-api-key': 'YOUR_API_KEY'
    },
