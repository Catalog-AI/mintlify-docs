...
<Tip>
**When to use:** Browse vendor collections before fetching products. Use with [Get All Products](/api-reference/endpoints/browse/list-listings) to get products from specific collections.
</Tip>
