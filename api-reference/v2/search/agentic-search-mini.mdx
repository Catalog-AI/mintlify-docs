...
description: "Fast unbounded product discovery with AI-powered attribute enrichment. Get up to 10 products with detailed attributes in milliseconds."
---
...
<Tip>
**When to use:** Ideal for autocomplete, quick previews, or when you need fast AI-enriched results with a small result set. For larger result sets with customer profile personalization, use [Agentic Search](/api-reference/endpoints/search/agentic-search).
</Tip>
