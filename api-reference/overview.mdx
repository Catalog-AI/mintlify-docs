...
<Card title="List Vendors" icon="store" href="/api-reference/endpoints/browse/list-vendors">
  **GET** `/api/vendors`
  ...
  Retrieve vendor summaries with product counts and latest update timestamps.
</Card>

<Card title="List Collections" icon="folder" href="/api-reference/endpoints/browse/list-collections">
  **POST** `/v1/collections`
  
  Retrieve collections from a specific vendor with pagination.
</Card>

<Card title="List All Products (Listings)" icon="list" href="/api-reference/endpoints/browse/list-listings">
  **POST** `/v1/listings`
  
  Retrieve collection products with pagination and filtering options.
</Card>
...
<Card title="Agentic Search Mini" icon="zap" href="/api-reference/endpoints/search/agentic-search-mini">
  **POST** `/v1/agentic-search-mini`
  ...
  Fast product discovery with optional AI enrichment (up to 10 results).
</Card>
